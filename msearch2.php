                    ...
                    <table id="example1" class="table table-bordered table-striped">
                       <thead>
                        ...
                        <tbody>
                          ...
                          // Debugging step: Check values
                          //echo "snumber: $snumber, enumber: $enumber, status: $status";
                          
                          $sql = "";
                          if ($status == 'All') {
                              $sql = "SELECT * FROM orders WHERE clientid='$clientid' AND orderid BETWEEN '$snumber' AND '$enumber'";
                          } else {
                              $sql = "SELECT * FROM orders WHERE clientid='$clientid' AND status='$status' AND orderid BETWEEN '$snumber' AND '$enumber'";
                          }
                          
                          // Debugging step: Check query
                          //echo "SQL Query: $sql";
