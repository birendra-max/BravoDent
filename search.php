        ...
        <div class="col-12">
          <div class="card" style="background-color: #454D55 !important;color: #FFF !important;font-weight: bold !important;">
            ...
            <div class="table table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="color:#FFF !important">
                <thead>
                  <tr>
                    <th>OrderID</th>
                    <th>Name</th>
                ...
                <tbody>
                  ...
                  if (strlen($_POST['orderid']) > 0 and !empty($_POST['orderid'])) {
                    ...
                    //die;
                    $em = $_SESSION['email'];
                    $sql = "SELECT * FROM orders where clientid='$em' and  (orderid like '%$orderid%' or fname like '%$orderid%')";
                    //die;
