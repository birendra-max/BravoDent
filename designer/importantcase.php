            ...
            <div class="table table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $i = 0;
                        $sql = "SELECT * FROM orders WHERE orderid in(SELECT orderid FROM chatbox WHERE orderid not in(SELECT c1.orderid FROM chatbox as c1 , chatbox as c2 WHERE c1.orderid = c2.orderid and c1.user_type='user' and c2.user_type='SKYDENT TEAM') and str_to_date(created_at,'%d-%b-%Y') >= '2025-04-26');";
