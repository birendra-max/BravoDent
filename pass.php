      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-danger" style="background-color: #343A40 !important; color: #FFF !important; font-weight: bold !important; box-shadow: 0px 8px 20px rgba(0, 0, 0, 0.8), 0px 4px 8px rgba(255, 255, 255, 0.05);">              <div class="card-header">
