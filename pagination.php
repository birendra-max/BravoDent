      ...
      <div class="row">
        ...
        <div class="col-2">
          <div class="form-group">
            ...
            <input type="button" name="donload_button" id="download_button" value="Download Now" class="btn btn-primary">
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="form-group">
            ...
            <div id="excelButtonContainer"></div> <!-- Excel button will be placed here -->
          </div>
        </div>
      </div>
      <!--   <div class="row">          -->
