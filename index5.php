                    ...
                    <table id="example1" class="table table-bordered table-striped">
                       <thead>
                        ...
                        <tbody>
                          ...
                          $i=0;                       
                           $sql="SELECT * FROM orders where clientid='$em' and status='Cancel'";
...
<script type="text/javascript">
 $(document).ready(function() {
    $('#redesign_button').click(function(event) { //Trigger on form submit
      
        //Validate fields if required using jQuery

        var postForm = { //Fetch form data
            'filestatus'     : $('#filestatus').val() //Store name fields value
        };

        $.ajax({ //Process the form using $.ajax()
            type      : 'POST', //Method type
            url       : 'redesignstatus.php', //Your form processing file URL
