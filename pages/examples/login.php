...
<head>
  ...
  <style type="text/css">
    ...
    .login-block { width:100%; height: auto; bottom: 0px !important; padding:10%; }
              ...
              while ($row2 = mysqli_fetch_assoc($rr2)) {
                  if ($f == 0) {
                      ...
                      <div class="carousel-item active">
                        <img class=" img-fluid" src="../../admin/<?php echo trim($row2['image'])?>" alt="bravo">
                      </div>
                      <?php
                  } else {
                      ?>
                      <div class="carousel-item">
                        <img class=" img-fluid" src="../../admin/<?php echo trim($row2['image'])?>" alt="First slide">
                      </div>
                      <?php
                  }
                  $f++;
